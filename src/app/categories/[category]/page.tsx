...
import CatComponent from '@/components/otherComponents/CatComponent';
...
const page = ({params}:CategoryPageProps) => {
    ...
    return (
        ...
        <div className='w-full h-[1500px] bg-slate-200 '>
             <Navbar />
             <div className='w-full h-[300px] md:h-[500px] shadow-md pt-20 '>
             ...
             <div className='w-full h-auto py-6 px-6 md:px-10 '>
                 <p className='text-center font-bold text-gray-950 text-[13px] leading-5 md:leading-8  md:text-lg '>{categoryData.description}</p>
             </div>
