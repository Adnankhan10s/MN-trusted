        ...
        <div>
            <div className='md:w-full  w-full  md:h-[300px] h-[500px] md:mt-8    flex  justify-center items-center  overflow-clip  '>
                <div className='md:flex md:justify-between md:px-48 items-center content-center  md:w-full md:space-x-10 mt-10 '>
                    ...
                    className=' md:mx-0 mx-auto  lg:w-[600px] w-[350px]  lg:h-[220px] h-[200px] overflow-clip border-dashed border-2 border-gray-800 text-center p-5'>
                    ...
                    className='mt-2 md:mt-0  mx-auto md:mx-0 lg:w-[600px] w-[350px] p-5 overflow-clip lg:h-[220px] h-[200px] border-2 border-dashed border-gray-800 text-center '>
