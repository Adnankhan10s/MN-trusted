...
const Hero = () => {
    return (
        <div className=' z-10 md:w-full h-[850px] md:h-[700px] 2xl:h-screen w-full md:bg-white bg-slate-300 border-b-2  border-black md:mt-0 relative  items-center' id='home'>

        <div className='absolute z-20 md:pt-28 pt-24  right-0 w-full h-[200px] flex-col place-items-center   md:h-[800px]'>
           ...
           <div className='md:w-full  font-bold text-center text-lg md:text-2xl lg:text-4xl 2xl:text-5xl'>
                   <h1 className={`md:bg-gradient-to-r  from-gray-700 via-indigo-900 to-gray-700  text-white md:bg-clip-text md:text-transparent p-4 ${poppins.className}`}>ARE YOU A BUSY ENTREPRENEUR IMPACTED BY<br/>
